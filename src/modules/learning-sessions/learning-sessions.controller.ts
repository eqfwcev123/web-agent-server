...
export class LearningSessionsController {
	...
	async create(
		...
		return await this.learningSessionsService.createSession(
			userId,
			createDto,
		);
	}
	...
	async findOne(
		@Param('id') id: string,
	): Promise<LearningSessionResponseDto | null> {
	...
	async updateProgress(
		...
		return await this.learningSessionsService.updateProgress(
			id,
			progressDto,
		);
	}
